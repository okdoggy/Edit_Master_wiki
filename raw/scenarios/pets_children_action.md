...
- Apple Burst mode 문서는 움직이는 피사체를 여러 프레임으로 확보하고 좋은 컷을 고르는 공식 흐름을 제공한다.
- Google Pixel Action Pan/고품질 사진 도움말은 움직이는 피사체와 창의적 블러를 다루는 촬영 근거다.
- Adobe 스마트폰 사진 자료와 National Geographic 스마트폰 팁은 낮은 시점, 빛, 연속 촬영으로 순간을 확보하는 방향을 보강한다.

### 시나리오 수정 포인트

- 아이·반려동물은 완벽한 단일 컷보다 연사/짧은 영상으로 표정과 자세를 선택하는 구조가 안전하다.
- 저조도에서는 긴 Night mode가 피사체 흔들림을 키울 수 있으므로 셔터 안정성을 우선한다.
