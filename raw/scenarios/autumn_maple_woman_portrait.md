...
- Samsung의 가을 촬영 가이드는 단풍색, 자연광, 계절 배경을 활용한 인물 촬영 근거를 제공한다.
- iPhone Photography School의 fall/leaves 튜토리얼은 단풍잎 전경, 역광 잎 디테일, 계절 색 강화와 과포화 방지를 함께 다룬다.
- Apple Portrait 문서와 Adobe Lightroom masking/color 문서는 인물 분리, 피부 보호, 배경 색 조절을 위한 공식 근거다.

### 시나리오 수정 포인트

- 단풍 warm trend는 배경에 적용하되 피부는 subject mask로 분리한다.
- 개인화는 따뜻한 계절감과 자연스러운 피부톤 사이의 강도 조절로 둔다.
