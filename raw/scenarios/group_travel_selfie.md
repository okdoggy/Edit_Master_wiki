...
- Apple selfie/Portrait 문서는 전면 카메라, 인물 모드, 조명 효과를 활용한 공식 촬영 흐름을 제공한다.
- Google Pixel 여행 사진 자료는 여행지에서 사람과 배경을 함께 살리는 구도 선택을 뒷받침한다.
- Adobe Lightroom 모바일 문서는 얼굴 밝기, 색, 배경 정리를 보정 단계에서 다루는 근거다.

### 시나리오 수정 포인트

- 단체 셀피는 모두의 얼굴이 프레임 중앙 쪽에 있고 가장자리 왜곡을 피하는 것이 우선이다.
- 장소감은 남기되 얼굴 노출이 서로 크게 벌어지지 않게 보정한다.
