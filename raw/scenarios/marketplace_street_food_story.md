...
- Google Pixel food tips는 음식 디테일과 배경 흐림, 음식 사진에서의 피사체 강조 흐름을 제공한다.
- iPhone Photography School food 튜토리얼은 자연광, 그림자 제어, 중립 배경, 각도 선택이 음식 사진에 중요하다고 정리한다.
- Adobe 스마트폰/Lightroom 모바일 자료와 National Geographic people tips는 여행·사람·장소 맥락을 함께 담는 다큐형 구성의 근거다.

### 시나리오 수정 포인트

- 시장 음식은 음식 단품보다 손, 상인, 간판, 거리 맥락을 함께 구성하는 shot set으로 다룬다.
- 색 보정은 컷마다 달라지지 않도록 WB를 시리즈 단위로 맞춘다.
