...
- Google Pixel 여행 사진 자료와 National Geographic 스마트폰 사진 팁은 여행 장면에서 장소감, 인물 크기, 빛의 방향을 함께 다루는 근거가 된다.
- Apple iPhone 카메라/Portrait 문서는 인물과 배경을 함께 다루는 촬영 옵션을 제공한다.
- Adobe Lightroom color/masking 자료는 노을 하늘과 전경을 분리해 보정하는 공식 근거다.

### 시나리오 수정 포인트

- 여행 스케일 컷은 인물을 크게 보이게 하는 것보다 장소의 크기와 사람의 위치 관계를 우선한다.
- 보정은 하늘 색을 살리되 foreground가 검게 막히지 않게 부분 보정한다.
