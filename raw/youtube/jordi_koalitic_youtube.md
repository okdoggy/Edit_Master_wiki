---
title: "Jordi Koalitic YouTube / Shorts"
category: "youtube"
priority: "B"
updated_at: "2026-04-17"
content_type: "actionable_tip_cards"
urls:
  - "https://www.shutterbug.com/content/5-easy-smartphone-tricks-will-make-your-videos-go-viral"
  - "https://www.digitalcameraworld.com/news/you-have-to-see-these-incredible-guitar-images-shot-on-a-smartphone-theyre-not-composites"
  - "https://www.youtube.com/@JordiKoalitic"
practical_tags:
  - "SNS"
  - "Lightroom"
  - "사진트릭"
...
# Jordi Koalitic YouTube / Shorts — 상황별 촬영/보정 팁

이 파일은 더 이상 단순 소스 메타데이터가 아니라, 실제 촬영/보정 때 바로 써먹는 레시피 형태로 정리한다.

## 바로 쓰는 팁 카드

### Tip 1. Jordi Koalitic/COOPH식 SNS용 창의적 트릭 사진을 만들 때

**촬영/작업 순서**
- 완성 이미지를 먼저 스케치하고, 카메라에 가까운 전경 소품과 먼 배경 피사체를 정한다.
- 초광각은 왜곡이 커서 트릭이 강해지고, 1x/2x는 더 자연스럽다. 결과에 맞춰 렌즈를 고른다.
- 소품은 렌즈 가까이, 사람/건물/하늘은 뒤에 두고 화면에서 크기가 맞을 때까지 앞뒤로 움직인다.
- BTS도 함께 촬영해 SNS 게시물에서 “결과 → 세팅 공개” 구조로 만든다.

**추천 시작값 / 조작값**
- Lens: 0.5x 과장 / 1x 균형 / 2x 압축
- Focus: 전경 소품에 맞추면 배경이 흐릴 수 있어 1x와 충분한 빛 사용
- Shutter: 사람 점프/동작은 밝은 낮에 촬영
- Burst/Video: 타이밍 트릭은 연속 확보

**보정 루틴**
- 불필요한 손/스탠드는 Remove/Heal로 정리
- 색은 소품과 배경의 보색 대비를 강화
- 크롭은 4:5 또는 9:16 SNS 비율까지 같이 만든다.

**주의할 점**
- 합성처럼 보이는 과한 보정보다 실제 세팅의 설득력이 중요하다.
- 안전하지 않은 자세/도로/높은 곳에서 트릭을 만들지 않는다.

**확실성:** Jordi/COOPH류 실전 패턴 기반.
**근거:** Digital Camera World/Shutterbug/EL PAÍS가 다룬 Koalitic식 practical effect와 COOPH 스마트폰 팁 패턴.

### Tip 2. 인스타그램·틱톡·블로그에 올릴 최종본을 만들 때
...
### Tip 4. 무엇을 찍어도 사진이 산만하고 초점/밝기가 흔들릴 때
...
### Jordi Koalitic — 바이럴 숏폼용 5개 스마트폰 트릭

**상황**
- 릴스/쇼츠에서 말보다 시각 훅으로 강하게 잡아야 할 때.

**촬영/작업 순서**
- 말 없이 음악과 비주얼 중심으로 구성한다.
- 준비 → 동작 → 결과가 1~2초 안에 보이도록 각 클립을 짧게 만든다.
- 결과 컷을 먼저 보여준 뒤 BTS를 붙이면 저장/공유율이 좋아진다.

**원문에 나온 트릭 이름**
- Slow-mo stick throw.
- Water follow slow-mo.
- Exposure trick.
- Soccer trick.
- Wet hair flip.

**주의점**
- 기사/영상 소개는 데모 중심이라 세부 노출값은 공개되지 않았다. 정확한 수치보다 동작 타이밍과 BTS 구성이 핵심이다.

### 집에서 만드는 와우 포토

**상황**
- 실내에서 별도 스튜디오 없이 강한 효과를 만들고 싶을 때.

**촬영 아이디어**
- 스파클러로 빛 입자 만들기.
- 베이프/연기성 요소로 레이어 만들기.
- 롱노출 + 라이트 페인팅으로 선/궤적 만들기.
- 마지막은 폰에서 대비/색만 정리.

**주의점**
- 불꽃/연기/전기 조명은 안전을 먼저 확인한다.
...
- https://www.shutterbug.com/content/create-eye-popping-photos-unique-ideas-trickster-jordi-koalitic-video
- https://www.shutterbug.com/content/5-easy-smartphone-tricks-will-make-your-videos-go-viral
- https://www.digitalcameraworld.com/news/you-have-to-see-these-incredible-guitar-images-shot-on-a-smartphone-theyre-not-composites
- https://www.youtube.com/@JordiKoalitic
