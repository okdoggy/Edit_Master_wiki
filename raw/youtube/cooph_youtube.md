...
urls:
  - "https://www.youtube.com/@TheCooph"
  - "https://www.youtube.com/watch?v=VkdU5sZ_0hI"
  - "https://socialblade.com/youtube/c/thecooph/similarrank/views"
  - "https://www.shutterbug.com/content/heres-how-take-great-landscape-photos-your-smartphone-video"
  - "https://www.shutterbug.com/content/7-classic-smartphone-photography-tips-tricks-videos"
practical_tags:
  - "SNS"
  - "RAW"
  - "DNG"
...
### COOPH — 집에서 찍는 여행 샷 / 미니어처 비행기

**상황**
- 여행 분위기는 만들고 싶은데 집 안에서 촬영해야 할 때.

**촬영/작업 순서**
- 책상 위에 미니어처 비행기를 둔다.
- 책, 컵, 종이, 상자 같은 집 소품으로 공항/여행 분위기를 만든다.
- 스마트폰을 낮은 각도로 가깝게 붙여 촬영한다.
- 배경은 단순하게 두고 색감/대비만 가볍게 정리한다.

**수치/설정**
- 원문에 카메라 수치 명시 없음. 핵심은 낮은 각도와 소품 스케일 조작.

### COOPH — Rollworld식 뒤틀린 풍경

**상황**
- 평범한 풍경을 SNS용 초현실 이미지로 바꾸고 싶을 때.

**작업 순서**
- 풍경/파노라마 사진을 준비한다.
- Rollworld류 앱으로 이미지를 비틀어 작은 행성/왜곡 효과를 만든다.
- 대비와 채도만 정리해 과한 보정 느낌을 줄인다.

**주의점**
- 촬영보다 앱 기반 후반 효과 의존도가 높다.
...
- https://store.cooph.com/en-us/blogs/techniques/this-landscape-photography-will-get-you-into-a-twist
- https://store.cooph.com/en-us
- https://www.youtube.com/@TheCooph
- https://www.youtube.com/watch?v=VkdU5sZ_0hI
- https://socialblade.com/youtube/c/thecooph/similarrank/views
- https://www.shutterbug.com/content/heres-how-take-great-landscape-photos-your-smartphone-video
