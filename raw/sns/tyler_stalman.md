...
urls:
  - "https://stalman.com/course"
  - "https://stalman.com/blog/Blog%20Post%20Title%20One-w6jys-p6zsc-4bsax-kn6km-z67b5-erclk-fjace-wtbdn-nlynj"
  - "https://x.com/stalman"
  - "https://www.instagram.com/stalman/"
...
# Tyler Stalman — 상황별 촬영/보정 팁

이 파일은 더 이상 단순 소스 메타데이터가 아니라, 실제 촬영/보정 때 바로 써먹는 레시피 형태로 정리한다.

**이 소스를 읽는 관점:** 사진과 영상 제작자가 같은 폰으로 촬영·편집·게시까지 이어가는 워크플로우 관점으로 읽는다.
...
### Tyler Stalman — 여행 슬로모 릴 빠른 제작

**상황**
- 여행 중 즉석에서 짧고 세련된 슬로모 영상을 만들 때.

**촬영/작업 순서**
- iPhone에서 최고 슬로모 모드로 촬영한다.
- 이동 중 iMovie로 1차 편집한다.
- 돌아와 Impulz LUT로 색감을 정리한다.
- 길이는 짧게, 화면 전환은 빠르게 유지한다.

**확인된 수치/조건**
- 원문 예시: iPhone 6, 240fps, iMovie, Impulz LUT.

**주의점**
- 예시는 오래된 iPhone 6 기준이므로 최신 기종에서는 “최고 슬로모 모드 + 빠른 편집 + LUT 색정리” 원리만 가져온다.

### Tyler Stalman — iPhone 영화 워크플로의 핵심

**상황**
- 상업적 느낌의 iPhone 영상 워크플로를 만들 때.

**작업 원칙**
- Apple Log / ProRes / LUTs 중심으로 촬영 파이프라인을 설계한다.
- 부드러운 카메라 움직임을 우선한다.
- 명확한 오디오를 확보한다.
- 모바일 편집 흐름을 과도하게 복잡하게 만들지 않는다.

**확인된 공개 코스 정보**
- 9 lessons + 3 bonus lessons, 총 60 minutes.
...
- https://stalman.com/blog/Blog%20Post%20Title%20One-w6jys-p6zsc-4bsax-kn6km-z67b5-erclk-fztsm
- https://stalman.com/course
- https://stalman.com/blog/Blog%20Post%20Title%20One-w6jys-p6zsc-4bsax-kn6km-z67b5-erclk-fjace-wtbdn-nlynj
- https://x.com/stalman
- https://www.instagram.com/stalman/
