...
- `scenario_action_pan_runner_cyclist`: raw/scenarios/action_pan_runner_cyclist.md
- `scenario_architecture_interior_wide`: raw/scenarios/architecture_interior_wide.md
- `scenario_autumn_maple_woman_portrait`: raw/scenarios/autumn_maple_woman_portrait.md
- `scenario_backlit_rim_light_portrait`: raw/scenarios/backlit_rim_light_portrait.md
- `scenario_backlit_silhouette_sunset`: raw/scenarios/backlit_silhouette_sunset.md
- `scenario_beach_backlit_portrait`: raw/scenarios/beach_backlit_portrait.md
...
- `scenario_glossy_product_reflection_control`: raw/scenarios/glossy_product_reflection_control.md
- `scenario_golden_hour_travel_scale`: raw/scenarios/golden_hour_travel_scale.md
- `scenario_group_best_face_gathering`: raw/scenarios/group_best_face_gathering.md
- `scenario_group_travel_selfie`: raw/scenarios/group_travel_selfie.md
- `scenario_harsh_noon_beach_portrait`: raw/scenarios/harsh_noon_beach_portrait.md
- `scenario_indoor_party_group`: raw/scenarios/indoor_party_group.md
- `scenario_landscape_sky_dynamic_range_2026`: raw/scenarios/landscape_sky_dynamic_range_2026.md
