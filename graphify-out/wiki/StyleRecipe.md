...
## Connections
- [[APPLIES TO Scenario indoor low light scene]] - `NIGHT_MODE_STABILIZED_WB_NOISE_RECIPE` [EXTRACTED]
- [[실내 저조도 스냅 — 노이즈와 화이트밸런스를 지키는 2026 촬영·보정 레시피 462adf]] - `USES_CONCEPT` [EXTRACTED]
