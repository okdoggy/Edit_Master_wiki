...
## Connections
- [[FeedbackEvent]] - `HAS_SECTION` [EXTRACTED]
- [[UserPreferenceProfile]] - `HAS_SECTION` [EXTRACTED]
- [[personalization_learning_schema]] - `HAS_CONTENT_TYPE` [EXTRACTED]
- [[recommendation]] - `IN_CATEGORY` [EXTRACTED]
- [[개인화 적용 원칙]] - `HAS_SECTION` [EXTRACTED]
- [[목적 6ca919]] - `HAS_SECTION` [EXTRACTED]
