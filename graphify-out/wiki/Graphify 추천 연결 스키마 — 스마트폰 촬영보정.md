...
## Connections
- [[1. 트렌드 추천]] - `HAS_SECTION` [EXTRACTED]
- [[2. 일반 추천]] - `HAS_SECTION` [EXTRACTED]
- [[3. 개인화 추천]] - `HAS_SECTION` [EXTRACTED]
- [[Edge patterns]] - `HAS_SECTION` [EXTRACTED]
- [[Graphify node taxonomy]] - `HAS_SECTION` [EXTRACTED]
...
- [[단풍나무 아래 여성 예시]] - `HAS_SECTION` [EXTRACTED]
