# night or food or photo

- id: `mode_night_or_food_or_photo`
- graph: scene-first
...
- **id**: mode_night_or_food_or_photo
- **key**: mode
- **value**: night_or_food_or_photo
- **name**: night or food or photo
- **source_file**: raw/scenarios/dim_restaurant_food.md
...
## Incoming
- [[scene_nodes/scene__어두운 레스토랑 음식 — 플래시 없이 맛있게 보이기__scenario_dim_restaurant_food|어두운 레스토랑 음식 — 플래시 없이 맛있게 보이기]] → `USES_MODE`
