...
- id: `tech_harsh_noon_beach_portrait_2x_portrait_reduces_distortion`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_harsh_noon_beach_portrait_2x_portrait_reduces_distortion
- **name**: 2x_portrait REDUCES_distortion
- **source_file**: raw/scenarios/harsh_noon_beach_portrait.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__한낮 해변 인물 — 강한 그림자와 날아간 하늘 잡기__scenario_harsh_noon_beach_portrait|한낮 해변 인물 — 강한 그림자와 날아간 하늘 잡기]] → `USES_TECHNIQUE`
