# Personalized recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기

- id: `rec_personalized_cafe_flatlay_dessert`
- graph: scene-first
...
## Properties
- **id**: rec_personalized_cafe_flatlay_dessert
- **name**: Personalized recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기
...
- `USES_FACET` → [[scene_nodes/scene__food cafe warm__editstyle_food_cafe_warm|food cafe warm]]
...
- [[scene_nodes/scene__food cafe warm__editstyle_food_cafe_warm|food cafe warm]] → `TRIGGERS`
