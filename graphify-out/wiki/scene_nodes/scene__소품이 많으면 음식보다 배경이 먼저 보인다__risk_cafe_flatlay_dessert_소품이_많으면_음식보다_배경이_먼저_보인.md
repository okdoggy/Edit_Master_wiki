...
- id: `risk_cafe_flatlay_dessert_소품이_많으면_음식보다_배경이_먼저_보인다.`
- graph: scene-first
- labels: Risk
...
## Incoming
- [[scene_nodes/scene__Trend recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기__rec_trend_cafe_flatlay_dessert|Trend recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기]] → `AVOIDS`
- [[scene_nodes/scene__General recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기__rec_general_cafe_flatlay_dessert|General recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기]] → `AVOIDS`
- [[scene_nodes/scene__Personalized recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기__rec_personalized_cafe_flatlay_dessert|Personalized recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기]] → `AVOIDS`
