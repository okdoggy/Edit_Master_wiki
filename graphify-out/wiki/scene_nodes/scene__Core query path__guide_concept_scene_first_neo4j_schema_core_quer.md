...
- id: `guide_concept_scene_first_neo4j_schema_core_query_path`
- graph: scene-first
- labels: Technique
...
## Incoming
- [[scene_nodes/scene__Scene-first Neo4j schema — camera recommendation graph__guide_scene_first_neo4j_schema|Scene-first Neo4j schema — camera recommendation graph]] → `REFERENCES`
