...
- id: `environment_rain_neon_street`
- graph: scene-first
...
- **id**: environment_rain_neon_street
- **key**: environment
- **value**: rain_neon_street
- **name**: rain neon street
- **source_file**: raw/scenarios/rain_neon_street_portrait.md
...
- `TRIGGERS` → [[scene_nodes/scene__General recommendation — 비 오는 밤 네온 거리 인물 — moody city look__rec_general_rain_neon_street_portrait|General recommendation — 비 오는 밤 네온 거리 인물 — moody city look]]
...
## Incoming
- [[scene_nodes/scene__비 오는 밤 네온 거리 인물 — moody city look__scenario_rain_neon_street_portrait|비 오는 밤 네온 거리 인물 — moody city look]] → `HAS_ENVIRONMENT`
...
- [[scene_nodes/scene__General recommendation — 비 오는 밤 네온 거리 인물 — moody city look__rec_general_rain_neon_street_portrait|General recommendation — 비 오는 밤 네온 거리 인물 — moody city look]] → `USES_FACET`
