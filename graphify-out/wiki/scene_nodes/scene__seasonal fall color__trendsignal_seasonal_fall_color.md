...
- id: `trendsignal_seasonal_fall_color`
- graph: scene-first
- labels: SceneFacet, TrendSignal
...
- **id**: trendsignal_seasonal_fall_color
- **key**: trend_signal
- **value**: seasonal_fall_color
- **name**: seasonal fall color
- **source_file**: raw/scenarios/autumn_maple_woman_portrait.md
...
## Outgoing
- `TRIGGERS` → [[scene_nodes/scene__Trend recommendation — 단풍나무 아래 여성 인물 — 트렌드_일반_개인화 추천 seed__rec_trend_autumn_maple_woman_portrait|Trend recommendation — 단풍나무 아래 여성 인물 — 트렌드/일반/개인화 추천 seed]]

## Incoming
- [[scene_nodes/scene__단풍나무 아래 여성 인물 — 트렌드_일반_개인화 추천 seed__scenario_autumn_maple_woman_portrait|단풍나무 아래 여성 인물 — 트렌드/일반/개인화 추천 seed]] → `HAS_TREND_SIGNAL`
- [[scene_nodes/scene__Example_ 단풍나무 아래 여성__obs_autumn_woman_maple|Example: 단풍나무 아래 여성]] → `OBSERVED_AS`
- [[scene_nodes/scene__Trend recommendation — 단풍나무 아래 여성 인물 — 트렌드_일반_개인화 추천 seed__rec_trend_autumn_maple_woman_portrait|Trend recommendation — 단풍나무 아래 여성 인물 — 트렌드/일반/개인화 추천 seed]] → `USES_FACET`
