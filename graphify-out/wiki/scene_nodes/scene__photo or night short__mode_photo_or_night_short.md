...
- **id**: mode_photo_or_night_short
- **key**: mode
- **value**: photo_or_night_short
- **name**: photo or night short
- **source_file**: raw/scenarios/indoor_party_group.md
...
## Incoming
- [[scene_nodes/scene__실내 생일파티·모임 단체사진 — 어두운 실내와 움직임__scenario_indoor_party_group|실내 생일파티·모임 단체사진 — 어두운 실내와 움직임]] → `USES_MODE`
