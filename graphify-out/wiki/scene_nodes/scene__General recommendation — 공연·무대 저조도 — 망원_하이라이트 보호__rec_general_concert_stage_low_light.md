...
- id: `rec_general_concert_stage_low_light`
- graph: scene-first
...
## Properties
- **id**: rec_general_concert_stage_low_light
- **name**: General recommendation — 공연·무대 저조도 — 망원/하이라이트 보호
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/concert_stage_low_light.md
...
- `USES_FACET` → [[scene_nodes/scene__performer__subject_performer|performer]]
...
- `USES_FACET` → [[scene_nodes/scene__3x 5x 10x__lens_3x_5x_10x|3x 5x 10x]]
- `USES_FACET` → [[scene_nodes/scene__photo or pro__mode_photo_or_pro|photo or pro]]
...
- [[scene_nodes/scene__performer__subject_performer|performer]] → `TRIGGERS`
...
- [[scene_nodes/scene__3x 5x 10x__lens_3x_5x_10x|3x 5x 10x]] → `TRIGGERS`
- [[scene_nodes/scene__photo or pro__mode_photo_or_pro|photo or pro]] → `TRIGGERS`
