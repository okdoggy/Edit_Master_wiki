...
- id: `tech_selfie_profile_portrait_close_front_camera_causes_face_distortion`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_selfie_profile_portrait_close_front_camera_causes_face_distortion
- **name**: close_front_camera CAUSES face_distortion
- **source_file**: raw/scenarios/selfie_profile_portrait.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__셀카_Profile — 왜곡 적고 자연스러운 얼굴 추천 seed__scenario_selfie_profile_portrait|셀카/Profile — 왜곡 적고 자연스러운 얼굴 추천 seed]] → `USES_TECHNIQUE`
