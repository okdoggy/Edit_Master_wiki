# General recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기

- id: `rec_general_cafe_drink_dessert_closeup`
- graph: scene-first
...
## Properties
- **id**: rec_general_cafe_drink_dessert_closeup
- **name**: General recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/cafe_drink_dessert_closeup.md
...
- `USES_FACET` → [[scene_nodes/scene__side or back light__light_side_or_back_light|side or back light]]
- `USES_FACET` → [[scene_nodes/scene__2x or macro__lens_2x_or_macro|2x or macro]]
- `USES_FACET` → [[scene_nodes/scene__photo or macro__mode_photo_or_macro|photo or macro]]
...
- [[scene_nodes/scene__side or back light__light_side_or_back_light|side or back light]] → `TRIGGERS`
- [[scene_nodes/scene__2x or macro__lens_2x_or_macro|2x or macro]] → `TRIGGERS`
- [[scene_nodes/scene__photo or macro__mode_photo_or_macro|photo or macro]] → `TRIGGERS`
