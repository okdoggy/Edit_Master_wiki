...
- id: `evidence_url_https___www.makeuseof.com_mirror_selfie_poses`
- graph: scene-first
- labels: Evidence
- source_file: raw/scenarios/mirror_selfie_ootd.md
- source_url: https://www.makeuseof.com/mirror-selfie-poses/
...
## Properties
- **id**: evidence_url_https___www.makeuseof.com_mirror_selfie_poses
- **name**: https://www.makeuseof.com/mirror-selfie-poses/
- **source_url**: https://www.makeuseof.com/mirror-selfie-poses/
- **source_file**: raw/scenarios/mirror_selfie_ootd.md
