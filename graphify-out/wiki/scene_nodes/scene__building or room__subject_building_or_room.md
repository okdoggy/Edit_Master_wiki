...
- **id**: subject_building_or_room
- **key**: subject
- **value**: building_or_room
- **name**: building or room
- **source_file**: raw/scenarios/architecture_interior_wide.md
...
## Incoming
- [[scene_nodes/scene__건축·실내 공간 — 초광각 왜곡 제어__scenario_architecture_interior_wide|건축·실내 공간 — 초광각 왜곡 제어]] → `HAS_SUBJECT`
