# Personalized recommendation — 집에서 제품 판매 사진 — 깨끗한 썸네일 만들기

- id: `rec_personalized_small_product_listing_photo`
- graph: scene-first
...
## Properties
- **id**: rec_personalized_small_product_listing_photo
- **name**: Personalized recommendation — 집에서 제품 판매 사진 — 깨끗한 썸네일 만들기
