# General recommendation — 도시 야경 장노출 — 빛줄기/스카이라인

- id: `rec_general_city_night_long_exposure`
- graph: scene-first
...
## Properties
- **id**: rec_general_city_night_long_exposure
- **name**: General recommendation — 도시 야경 장노출 — 빛줄기/스카이라인
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/city_night_long_exposure.md
...
- `USES_FACET` → [[scene_nodes/scene__city lights__subject_city_lights|city lights]]
- `USES_FACET` → [[scene_nodes/scene__night city__environment_night_city|night city]]
- `USES_FACET` → [[scene_nodes/scene__pro or night__mode_pro_or_night|pro or night]]
- `USES_FACET` → [[scene_nodes/scene__1x 2x 5x__lens_1x_2x_5x|1x 2x 5x]]
...
- [[scene_nodes/scene__city lights__subject_city_lights|city lights]] → `TRIGGERS`
- [[scene_nodes/scene__night city__environment_night_city|night city]] → `TRIGGERS`
- [[scene_nodes/scene__pro or night__mode_pro_or_night|pro or night]] → `TRIGGERS`
- [[scene_nodes/scene__1x 2x 5x__lens_1x_2x_5x|1x 2x 5x]] → `TRIGGERS`
