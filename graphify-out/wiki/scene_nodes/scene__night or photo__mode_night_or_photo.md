...
## Outgoing
- `TRIGGERS` → [[scene_nodes/scene__General recommendation — 도시 야경 유리창 반사 — 산만한 반사 정리__rec_general_city_window_reflection|General recommendation — 도시 야경 유리창 반사 — 산만한 반사 정리]]

## Incoming
- [[scene_nodes/scene__도시 야경 유리창 반사 — 산만한 반사 정리__scenario_city_window_reflection|도시 야경 유리창 반사 — 산만한 반사 정리]] → `USES_MODE`
- [[scene_nodes/scene__General recommendation — 도시 야경 유리창 반사 — 산만한 반사 정리__rec_general_city_window_reflection|General recommendation — 도시 야경 유리창 반사 — 산만한 반사 정리]] → `USES_FACET`
