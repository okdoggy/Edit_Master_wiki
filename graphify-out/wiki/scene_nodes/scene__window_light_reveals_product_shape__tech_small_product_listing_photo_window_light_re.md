...
- id: `tech_small_product_listing_photo_window_light_reveals_product_shape`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_small_product_listing_photo_window_light_reveals_product_shape
- **name**: window_light_reveals_product_shape
- **source_file**: raw/scenarios/small_product_listing_photo.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__집에서 제품 판매 사진 — 깨끗한 썸네일 만들기__scenario_small_product_listing_photo|집에서 제품 판매 사진 — 깨끗한 썸네일 만들기]] → `USES_TECHNIQUE`
