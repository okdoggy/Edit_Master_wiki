# General recommendation — 여행 골든아워 — wide/detail/scale 3컷 추천

- id: `rec_general_golden_hour_travel_scale`
- graph: scene-first
...
## Properties
- **id**: rec_general_golden_hour_travel_scale
- **name**: General recommendation — 여행 골든아워 — wide/detail/scale 3컷 추천
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/golden_hour_travel_scale.md
...
- `USES_FACET` → [[scene_nodes/scene__traveler__subject_traveler|traveler]]
...
- `USES_FACET` → [[scene_nodes/scene__0.5x 1x 2x 5x__lens_0_5x_1x_2x_5x|0.5x 1x 2x 5x]]
...
- [[scene_nodes/scene__traveler__subject_traveler|traveler]] → `TRIGGERS`
...
- [[scene_nodes/scene__0.5x 1x 2x 5x__lens_0_5x_1x_2x_5x|0.5x 1x 2x 5x]] → `TRIGGERS`
