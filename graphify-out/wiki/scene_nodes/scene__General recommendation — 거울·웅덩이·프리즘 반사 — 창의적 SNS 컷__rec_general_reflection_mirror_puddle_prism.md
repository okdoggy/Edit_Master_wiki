...
- id: `rec_general_reflection_mirror_puddle_prism`
- graph: scene-first
...
## Properties
- **id**: rec_general_reflection_mirror_puddle_prism
- **name**: General recommendation — 거울·웅덩이·프리즘 반사 — 창의적 SNS 컷
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/reflection_mirror_puddle_prism.md
...
- `USES_FACET` → [[scene_nodes/scene__person or city__subject_person_or_city|person or city]]
- `USES_FACET` → [[scene_nodes/scene__urban or nature__environment_urban_or_nature|urban or nature]]
- `USES_FACET` → [[scene_nodes/scene__0.5x 1x 2x__lens_0_5x_1x_2x|0.5x 1x 2x]]
...
- [[scene_nodes/scene__person or city__subject_person_or_city|person or city]] → `TRIGGERS`
- [[scene_nodes/scene__urban or nature__environment_urban_or_nature|urban or nature]] → `TRIGGERS`
- [[scene_nodes/scene__0.5x 1x 2x__lens_0_5x_1x_2x|0.5x 1x 2x]] → `TRIGGERS`
