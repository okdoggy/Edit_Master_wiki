# clear face warm background

- id: `satisfactionsignal_clear_face_warm_background`
- graph: scene-first
- labels: SatisfactionSignal, SceneFacet
- source_file: raw/scenarios/autumn_maple_woman_portrait.md
- source_url: 

## Properties
- **id**: satisfactionsignal_clear_face_warm_background
- **key**: satisfaction_signal
- **value**: clear_face_warm_background
- **name**: clear face warm background
- **source_file**: raw/scenarios/autumn_maple_woman_portrait.md
...
## Incoming
- [[scene_nodes/scene__단풍나무 아래 여성 인물 — 트렌드_일반_개인화 추천 seed__scenario_autumn_maple_woman_portrait|단풍나무 아래 여성 인물 — 트렌드/일반/개인화 추천 seed]] → `HAS_SATISFACTION_SIGNAL`
