...
- **id**: risk_color_inaccuracy
- **key**: risk
- **value**: color_inaccuracy
- **name**: color inaccuracy
- **source_file**: raw/scenarios/small_product_listing_photo.md
...
## Incoming
- [[scene_nodes/scene__집에서 제품 판매 사진 — 깨끗한 썸네일 만들기__scenario_small_product_listing_photo|집에서 제품 판매 사진 — 깨끗한 썸네일 만들기]] → `HAS_RISK`
