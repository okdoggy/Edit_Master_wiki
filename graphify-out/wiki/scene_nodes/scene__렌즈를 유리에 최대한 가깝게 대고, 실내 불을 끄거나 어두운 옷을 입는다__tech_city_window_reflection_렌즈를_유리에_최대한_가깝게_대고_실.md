...
- id: `tech_city_window_reflection_렌즈를_유리에_최대한_가깝게_대고_실내_불을_끄거나_어두운_옷을_입는다.`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_city_window_reflection_렌즈를_유리에_최대한_가깝게_대고_실내_불을_끄거나_어두운_옷을_입는다.
- **name**: 렌즈를 유리에 최대한 가깝게 대고, 실내 불을 끄거나 어두운 옷을 입는다.
- **source_file**: raw/scenarios/city_window_reflection.md
...
## Incoming
- [[scene_nodes/scene__Trend recommendation — 도시 야경 유리창 반사 — 산만한 반사 정리__rec_trend_city_window_reflection|Trend recommendation — 도시 야경 유리창 반사 — 산만한 반사 정리]] → `USES_TECHNIQUE`
- [[scene_nodes/scene__General recommendation — 도시 야경 유리창 반사 — 산만한 반사 정리__rec_general_city_window_reflection|General recommendation — 도시 야경 유리창 반사 — 산만한 반사 정리]] → `USES_TECHNIQUE`
- [[scene_nodes/scene__Personalized recommendation — 도시 야경 유리창 반사 — 산만한 반사 정리__rec_personalized_city_window_reflection|Personalized recommendation — 도시 야경 유리창 반사 — 산만한 반사 정리]] → `USES_TECHNIQUE`
