...
- id: `risk_wide_angle_face_distortion`
- graph: scene-first
...
- **id**: risk_wide_angle_face_distortion
- **key**: risk
- **value**: wide_angle_face_distortion
- **name**: wide angle face distortion
- **source_file**: raw/scenarios/selfie_profile_portrait.md
...
## Incoming
- [[scene_nodes/scene__셀카_Profile — 왜곡 적고 자연스러운 얼굴 추천 seed__scenario_selfie_profile_portrait|셀카/Profile — 왜곡 적고 자연스러운 얼굴 추천 seed]] → `HAS_RISK`
