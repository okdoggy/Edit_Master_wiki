...
- id: `risk_cafe_drink_dessert_closeup_clarity를_과하게_올리면_크림이_딱딱해_보인다.`
- graph: scene-first
- labels: Risk
...
## Properties
- **id**: risk_cafe_drink_dessert_closeup_clarity를_과하게_올리면_크림이_딱딱해_보인다.
- **name**: Clarity를 과하게 올리면 크림이 딱딱해 보인다.
- **source_file**: raw/scenarios/cafe_drink_dessert_closeup.md
...
## Incoming
- [[scene_nodes/scene__Trend recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기__rec_trend_cafe_drink_dessert_closeup|Trend recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기]] → `AVOIDS`
- [[scene_nodes/scene__General recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기__rec_general_cafe_drink_dessert_closeup|General recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기]] → `AVOIDS`
- [[scene_nodes/scene__Personalized recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기__rec_personalized_cafe_drink_dessert_closeup|Personalized recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기]] → `AVOIDS`
