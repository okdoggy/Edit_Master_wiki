...
- id: `tech_autumn_maple_woman_portrait_autumn_foliage_supports_warm_color_grade`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_autumn_maple_woman_portrait_autumn_foliage_supports_warm_color_grade
- **name**: autumn_foliage SUPPORTS warm_color_grade
- **source_file**: raw/scenarios/autumn_maple_woman_portrait.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__단풍나무 아래 여성 인물 — 트렌드_일반_개인화 추천 seed__scenario_autumn_maple_woman_portrait|단풍나무 아래 여성 인물 — 트렌드/일반/개인화 추천 seed]] → `USES_TECHNIQUE`
