...
- id: `param_autumn_maple_woman_portrait_green이_탁하면_green_saturation__10__25_yellow_hue를_orange_쪽으로_약간.`
- graph: scene-first
- labels: Parameter
...
## Properties
- **id**: param_autumn_maple_woman_portrait_green이_탁하면_green_saturation__10__25_yellow_hue를_orange_쪽으로_약간.
- **name**: Green이 탁하면 Green Saturation -10~-25, Yellow Hue를 orange 쪽으로 약간.
- **source_file**: raw/scenarios/autumn_maple_woman_portrait.md
