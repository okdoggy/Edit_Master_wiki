...
- id: `tech_city_night_long_exposure_tripod_enables_long_exposure`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_city_night_long_exposure_tripod_enables_long_exposure
- **name**: tripod ENABLES_long_exposure
- **source_file**: raw/scenarios/city_night_long_exposure.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__도시 야경 장노출 — 빛줄기_스카이라인__scenario_city_night_long_exposure|도시 야경 장노출 — 빛줄기/스카이라인]] → `USES_TECHNIQUE`
