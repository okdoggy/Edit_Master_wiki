...
- id: `tech_reflection_mirror_puddle_prism_symmetry_increases_visual_interest`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_reflection_mirror_puddle_prism_symmetry_increases_visual_interest
- **name**: symmetry INCREASES_visual_interest
- **source_file**: raw/scenarios/reflection_mirror_puddle_prism.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__거울·웅덩이·프리즘 반사 — 창의적 SNS 컷__scenario_reflection_mirror_puddle_prism|거울·웅덩이·프리즘 반사 — 창의적 SNS 컷]] → `USES_TECHNIQUE`
