...
- id: `rec_general_beach_backlit_portrait`
- graph: scene-first
...
## Properties
- **id**: rec_general_beach_backlit_portrait
- **name**: General recommendation — 해변 역광 인물 — 여름/휴양지 SNS 스타일
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/beach_backlit_portrait.md
...
- `USES_FACET` → [[scene_nodes/scene__backlight golden hour__light_backlight_golden_hour|backlight golden hour]]
...
- [[scene_nodes/scene__backlight golden hour__light_backlight_golden_hour|backlight golden hour]] → `TRIGGERS`
