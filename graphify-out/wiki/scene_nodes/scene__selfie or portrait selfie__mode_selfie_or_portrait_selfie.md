# selfie or portrait selfie

- id: `mode_selfie_or_portrait_selfie`
- graph: scene-first
...
- **id**: mode_selfie_or_portrait_selfie
- **key**: mode
- **value**: selfie_or_portrait_selfie
- **name**: selfie or portrait selfie
- **source_file**: raw/scenarios/selfie_profile_portrait.md
...
## Incoming
- [[scene_nodes/scene__셀카_Profile — 왜곡 적고 자연스러운 얼굴 추천 seed__scenario_selfie_profile_portrait|셀카/Profile — 왜곡 적고 자연스러운 얼굴 추천 seed]] → `USES_MODE`
