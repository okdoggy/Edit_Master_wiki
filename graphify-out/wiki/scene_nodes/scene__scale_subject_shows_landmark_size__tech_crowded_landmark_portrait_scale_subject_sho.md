...
- id: `tech_crowded_landmark_portrait_scale_subject_shows_landmark_size`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_crowded_landmark_portrait_scale_subject_shows_landmark_size
- **name**: scale_subject_shows_landmark_size
- **source_file**: raw/scenarios/crowded_landmark_portrait.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__관광지 랜드마크 인물 — 사람 많은 배경 정리__scenario_crowded_landmark_portrait|관광지 랜드마크 인물 — 사람 많은 배경 정리]] → `USES_TECHNIQUE`
