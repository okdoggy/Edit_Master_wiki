...
- id: `tech_cafe_flatlay_dessert_접시와_컵이_가장자리에서_잘리지_않게_여백을_둔다.`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_cafe_flatlay_dessert_접시와_컵이_가장자리에서_잘리지_않게_여백을_둔다.
- **name**: 접시와 컵이 가장자리에서 잘리지 않게 여백을 둔다.
- **source_file**: raw/scenarios/cafe_flatlay_dessert.md
...
## Incoming
- [[scene_nodes/scene__Trend recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기__rec_trend_cafe_flatlay_dessert|Trend recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기]] → `USES_TECHNIQUE`
- [[scene_nodes/scene__General recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기__rec_general_cafe_flatlay_dessert|General recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기]] → `USES_TECHNIQUE`
- [[scene_nodes/scene__Personalized recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기__rec_personalized_cafe_flatlay_dessert|Personalized recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기]] → `USES_TECHNIQUE`
