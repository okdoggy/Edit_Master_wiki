...
- id: `light_golden_hour_or_backlight`
- graph: scene-first
...
- **id**: light_golden_hour_or_backlight
- **key**: light
- **value**: golden_hour_or_backlight
- **name**: golden hour or backlight
- **source_file**: raw/scenarios/autumn_maple_woman_portrait.md
...
## Incoming
- [[scene_nodes/scene__단풍나무 아래 여성 인물 — 트렌드_일반_개인화 추천 seed__scenario_autumn_maple_woman_portrait|단풍나무 아래 여성 인물 — 트렌드/일반/개인화 추천 seed]] → `HAS_LIGHT`
