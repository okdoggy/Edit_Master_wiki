...
- id: `environment_travel_landmark`
- graph: scene-first
...
- **id**: environment_travel_landmark
- **key**: environment
- **value**: travel_landmark
- **name**: travel landmark
- **source_file**: raw/scenarios/group_travel_selfie.md
...
## Outgoing
- `TRIGGERS` → [[scene_nodes/scene__Trend recommendation — 단체 여행 셀피_그룹샷 — 얼굴 왜곡 줄이기__rec_trend_group_travel_selfie|Trend recommendation — 단체 여행 셀피/그룹샷 — 얼굴 왜곡 줄이기]]
...
## Incoming
- [[scene_nodes/scene__단체 여행 셀피_그룹샷 — 얼굴 왜곡 줄이기__scenario_group_travel_selfie|단체 여행 셀피/그룹샷 — 얼굴 왜곡 줄이기]] → `HAS_ENVIRONMENT`
- [[scene_nodes/scene__Trend recommendation — 단체 여행 셀피_그룹샷 — 얼굴 왜곡 줄이기__rec_trend_group_travel_selfie|Trend recommendation — 단체 여행 셀피/그룹샷 — 얼굴 왜곡 줄이기]] → `USES_FACET`
