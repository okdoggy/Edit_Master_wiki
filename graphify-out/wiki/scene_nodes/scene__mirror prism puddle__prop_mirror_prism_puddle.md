...
- id: `prop_mirror_prism_puddle`
- graph: scene-first
- labels: Prop, SceneFacet
...
- **id**: prop_mirror_prism_puddle
- **key**: prop
- **value**: mirror_prism_puddle
- **name**: mirror prism puddle
- **source_file**: raw/scenarios/reflection_mirror_puddle_prism.md
...
## Incoming
- [[scene_nodes/scene__거울·웅덩이·프리즘 반사 — 창의적 SNS 컷__scenario_reflection_mirror_puddle_prism|거울·웅덩이·프리즘 반사 — 창의적 SNS 컷]] → `HAS_FACET`
