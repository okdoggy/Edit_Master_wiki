# General recommendation — 관광지 랜드마크 인물 — 사람 많은 배경 정리

- id: `rec_general_crowded_landmark_portrait`
- graph: scene-first
...
## Properties
- **id**: rec_general_crowded_landmark_portrait
- **name**: General recommendation — 관광지 랜드마크 인물 — 사람 많은 배경 정리
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/crowded_landmark_portrait.md
...
- `USES_FACET` → [[scene_nodes/scene__daylight or golden hour__light_daylight_or_golden_hour|daylight or golden hour]]
- `USES_FACET` → [[scene_nodes/scene__2x 3x or 1x__lens_2x_3x_or_1x|2x 3x or 1x]]
...
- [[scene_nodes/scene__daylight or golden hour__light_daylight_or_golden_hour|daylight or golden hour]] → `TRIGGERS`
- [[scene_nodes/scene__2x 3x or 1x__lens_2x_3x_or_1x|2x 3x or 1x]] → `TRIGGERS`
