...
- id: `rec_personalized_pets_children_action`
- graph: scene-first
...
## Properties
- **id**: rec_personalized_pets_children_action
- **name**: Personalized recommendation — 아이·반려동물 액션 — 순간 포착/연사/짧은 영상
...
- `USES_FACET` → [[scene_nodes/scene__clear action__editstyle_clear_action|clear action]]
...
- [[scene_nodes/scene__clear action__editstyle_clear_action|clear action]] → `TRIGGERS`
