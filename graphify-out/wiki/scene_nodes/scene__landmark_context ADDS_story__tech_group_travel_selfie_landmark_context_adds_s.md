...
- id: `tech_group_travel_selfie_landmark_context_adds_story`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_group_travel_selfie_landmark_context_adds_story
- **name**: landmark_context ADDS_story
- **source_file**: raw/scenarios/group_travel_selfie.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__단체 여행 셀피_그룹샷 — 얼굴 왜곡 줄이기__scenario_group_travel_selfie|단체 여행 셀피/그룹샷 — 얼굴 왜곡 줄이기]] → `USES_TECHNIQUE`
