# Personalized recommendation — 여행 골든아워 — wide/detail/scale 3컷 추천

- id: `rec_personalized_golden_hour_travel_scale`
- graph: scene-first
...
## Properties
- **id**: rec_personalized_golden_hour_travel_scale
- **name**: Personalized recommendation — 여행 골든아워 — wide/detail/scale 3컷 추천
