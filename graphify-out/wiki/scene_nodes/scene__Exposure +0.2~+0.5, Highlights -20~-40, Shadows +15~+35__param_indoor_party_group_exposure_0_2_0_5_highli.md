...
- id: `param_indoor_party_group_exposure_+0.2_+0.5_highlights__20__40_shadows_+15_+35.`
- graph: scene-first
- labels: Parameter
...
## Properties
- **id**: param_indoor_party_group_exposure_+0.2_+0.5_highlights__20__40_shadows_+15_+35.
- **name**: Exposure +0.2~+0.5, Highlights -20~-40, Shadows +15~+35.
- **source_file**: raw/scenarios/indoor_party_group.md
...
## Incoming
- [[scene_nodes/scene__Trend recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임__rec_trend_indoor_party_group|Trend recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임]] → `SETS_PARAMETER`
- [[scene_nodes/scene__General recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임__rec_general_indoor_party_group|General recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임]] → `SETS_PARAMETER`
- [[scene_nodes/scene__Personalized recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임__rec_personalized_indoor_party_group|Personalized recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임]] → `SETS_PARAMETER`
