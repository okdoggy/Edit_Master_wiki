...
- id: `tech_architecture_interior_wide_level_corrects_verticals`
- graph: scene-first
- labels: Technique
...
## Incoming
- [[scene_nodes/scene__건축·실내 공간 — 초광각 왜곡 제어__scenario_architecture_interior_wide|건축·실내 공간 — 초광각 왜곡 제어]] → `USES_TECHNIQUE`
