# Trend recommendation — 단풍나무 아래 여성 인물 — 트렌드/일반/개인화 추천 seed

- id: `rec_trend_autumn_maple_woman_portrait`
- graph: scene-first
...
## Properties
- **id**: rec_trend_autumn_maple_woman_portrait
- **name**: Trend recommendation — 단풍나무 아래 여성 인물 — 트렌드/일반/개인화 추천 seed
- **channel**: trend
- **rank_score**: 0.75
- **source_file**: raw/scenarios/autumn_maple_woman_portrait.md
...
- `USES_FACET` → [[scene_nodes/scene__seasonal fall color__trendsignal_seasonal_fall_color|seasonal fall color]]
...
- [[scene_nodes/scene__seasonal fall color__trendsignal_seasonal_fall_color|seasonal fall color]] → `TRIGGERS`
- [[scene_nodes/scene__autumn maple tree__environment_autumn_maple_tree|autumn maple tree]] → `TRIGGERS`
