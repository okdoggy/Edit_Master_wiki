...
- id: `tech_rain_neon_street_portrait_night_mode_increases_exposure_time`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_rain_neon_street_portrait_night_mode_increases_exposure_time
- **name**: night_mode INCREASES_exposure_time
- **source_file**: raw/scenarios/rain_neon_street_portrait.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__비 오는 밤 네온 거리 인물 — moody city look__scenario_rain_neon_street_portrait|비 오는 밤 네온 거리 인물 — moody city look]] → `USES_TECHNIQUE`
