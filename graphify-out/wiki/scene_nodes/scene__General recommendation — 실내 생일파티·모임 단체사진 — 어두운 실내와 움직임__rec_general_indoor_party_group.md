# General recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임

- id: `rec_general_indoor_party_group`
- graph: scene-first
...
## Properties
- **id**: rec_general_indoor_party_group
- **name**: General recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/indoor_party_group.md
...
- `USES_FACET` → [[scene_nodes/scene__warm low light__light_warm_low_light|warm low light]]
- `USES_FACET` → [[scene_nodes/scene__1x or 0 5x__lens_1x_or_0_5x|1x or 0 5x]]
- `USES_FACET` → [[scene_nodes/scene__photo or night short__mode_photo_or_night_short|photo or night short]]
...
- [[scene_nodes/scene__warm low light__light_warm_low_light|warm low light]] → `TRIGGERS`
- [[scene_nodes/scene__1x or 0 5x__lens_1x_or_0_5x|1x or 0 5x]] → `TRIGGERS`
- [[scene_nodes/scene__photo or night short__mode_photo_or_night_short|photo or night short]] → `TRIGGERS`
