...
- **id**: risk_blown_city_lights
- **key**: risk
- **value**: blown_city_lights
- **name**: blown city lights
- **source_file**: raw/scenarios/city_window_reflection.md
...
## Incoming
- [[scene_nodes/scene__도시 야경 유리창 반사 — 산만한 반사 정리__scenario_city_window_reflection|도시 야경 유리창 반사 — 산만한 반사 정리]] → `HAS_RISK`
