...
- id: `param_cafe_drink_dessert_closeup_exposure_+0.1_+0.3_highlights__10__30_shadows_+5_+15.`
- graph: scene-first
- labels: Parameter
...
## Properties
- **id**: param_cafe_drink_dessert_closeup_exposure_+0.1_+0.3_highlights__10__30_shadows_+5_+15.
- **name**: Exposure +0.1~+0.3, Highlights -10~-30, Shadows +5~+15.
- **source_file**: raw/scenarios/cafe_drink_dessert_closeup.md
...
## Incoming
- [[scene_nodes/scene__Trend recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기__rec_trend_cafe_drink_dessert_closeup|Trend recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기]] → `SETS_PARAMETER`
- [[scene_nodes/scene__General recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기__rec_general_cafe_drink_dessert_closeup|General recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기]] → `SETS_PARAMETER`
- [[scene_nodes/scene__Personalized recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기__rec_personalized_cafe_drink_dessert_closeup|Personalized recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기]] → `SETS_PARAMETER`
