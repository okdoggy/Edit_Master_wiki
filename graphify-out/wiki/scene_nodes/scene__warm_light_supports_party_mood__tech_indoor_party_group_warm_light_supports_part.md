...
- id: `tech_indoor_party_group_warm_light_supports_party_mood`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_indoor_party_group_warm_light_supports_party_mood
- **name**: warm_light_supports_party_mood
- **source_file**: raw/scenarios/indoor_party_group.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__실내 생일파티·모임 단체사진 — 어두운 실내와 움직임__scenario_indoor_party_group|실내 생일파티·모임 단체사진 — 어두운 실내와 움직임]] → `USES_TECHNIQUE`
