...
- **id**: light_harsh_overhead_sun
- **key**: light
- **value**: harsh_overhead_sun
- **name**: harsh overhead sun
- **source_file**: raw/scenarios/harsh_noon_beach_portrait.md
...
## Incoming
- [[scene_nodes/scene__한낮 해변 인물 — 강한 그림자와 날아간 하늘 잡기__scenario_harsh_noon_beach_portrait|한낮 해변 인물 — 강한 그림자와 날아간 하늘 잡기]] → `HAS_LIGHT`
