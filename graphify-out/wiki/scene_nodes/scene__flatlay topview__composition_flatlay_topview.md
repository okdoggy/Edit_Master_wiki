...
- id: `composition_flatlay_topview`
- graph: scene-first
- labels: Composition, SceneFacet
...
- **id**: composition_flatlay_topview
- **key**: composition
- **value**: flatlay_topview
- **name**: flatlay topview
- **source_file**: raw/scenarios/cafe_flatlay_dessert.md
...
## Incoming
- [[scene_nodes/scene__카페 디저트 플랫레이 — 수평과 왜곡 잡기__scenario_cafe_flatlay_dessert|카페 디저트 플랫레이 — 수평과 왜곡 잡기]] → `HAS_FACET`
