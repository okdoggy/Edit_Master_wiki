...
- id: `tech_fashion_ootd_portrait_outfit_color_requires_skin_tone_protection`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_fashion_ootd_portrait_outfit_color_requires_skin_tone_protection
- **name**: outfit_color REQUIRES_skin_tone_protection
- **source_file**: raw/scenarios/fashion_ootd_portrait.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__패션_OOTD 인물 — 전신 비율과 옷 색을 살리는 추천 seed__scenario_fashion_ootd_portrait|패션/OOTD 인물 — 전신 비율과 옷 색을 살리는 추천 seed]] → `USES_TECHNIQUE`
