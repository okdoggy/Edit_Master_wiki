...
- id: `tech_cafe_drink_dessert_closeup_컵_케이크_전체는_1x_2x_거품_시럽_크림은_macro_또는_2x.`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_cafe_drink_dessert_closeup_컵_케이크_전체는_1x_2x_거품_시럽_크림은_macro_또는_2x.
- **name**: 컵/케이크 전체는 1x/2x, 거품/시럽/크림은 macro 또는 2x.
- **source_file**: raw/scenarios/cafe_drink_dessert_closeup.md
...
## Incoming
- [[scene_nodes/scene__Trend recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기__rec_trend_cafe_drink_dessert_closeup|Trend recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기]] → `USES_TECHNIQUE`
- [[scene_nodes/scene__General recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기__rec_general_cafe_drink_dessert_closeup|General recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기]] → `USES_TECHNIQUE`
- [[scene_nodes/scene__Personalized recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기__rec_personalized_cafe_drink_dessert_closeup|Personalized recommendation — 카페 음료·디저트 클로즈업 — 질감과 반짝임 살리기]] → `USES_TECHNIQUE`
