...
- id: `tech_window_light_cafe_portrait_negative_space_supports_text_overlay`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_window_light_cafe_portrait_negative_space_supports_text_overlay
- **name**: negative_space SUPPORTS_text_overlay
- **source_file**: raw/scenarios/window_light_cafe_portrait.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__카페 창가 인물 — 자연광_인플루언서 프로필__scenario_window_light_cafe_portrait|카페 창가 인물 — 자연광/인플루언서 프로필]] → `USES_TECHNIQUE`
