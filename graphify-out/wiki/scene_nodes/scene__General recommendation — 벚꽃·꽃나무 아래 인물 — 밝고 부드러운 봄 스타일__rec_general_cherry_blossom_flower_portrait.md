# General recommendation — 벚꽃·꽃나무 아래 인물 — 밝고 부드러운 봄 스타일

- id: `rec_general_cherry_blossom_flower_portrait`
- graph: scene-first
...
## Properties
- **id**: rec_general_cherry_blossom_flower_portrait
- **name**: General recommendation — 벚꽃·꽃나무 아래 인물 — 밝고 부드러운 봄 스타일
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/cherry_blossom_flower_portrait.md
...
- `USES_FACET` → [[scene_nodes/scene__2x portrait__lens_2x_portrait|2x portrait]]
- `USES_FACET` → [[scene_nodes/scene__soft skin clean background__satisfactionsignal_soft_skin_clean_background|soft skin clean background]]
...
- [[scene_nodes/scene__2x portrait__lens_2x_portrait|2x portrait]] → `TRIGGERS`
- [[scene_nodes/scene__soft skin clean background__satisfactionsignal_soft_skin_clean_background|soft skin clean background]] → `TRIGGERS`
