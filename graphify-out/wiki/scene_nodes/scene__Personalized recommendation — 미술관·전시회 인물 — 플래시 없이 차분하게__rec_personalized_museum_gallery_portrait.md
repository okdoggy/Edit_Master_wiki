# Personalized recommendation — 미술관·전시회 인물 — 플래시 없이 차분하게

- id: `rec_personalized_museum_gallery_portrait`
- graph: scene-first
...
## Properties
- **id**: rec_personalized_museum_gallery_portrait
- **name**: Personalized recommendation — 미술관·전시회 인물 — 플래시 없이 차분하게
...
- `USES_FACET` → [[scene_nodes/scene__minimal clean__editstyle_minimal_clean|minimal clean]]
...
- [[scene_nodes/scene__minimal clean__editstyle_minimal_clean|minimal clean]] → `TRIGGERS`
