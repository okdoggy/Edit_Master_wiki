...
- id: `tech_cafe_flatlay_dessert_0_5x_fits_large_table_but_distorts_edges`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_cafe_flatlay_dessert_0_5x_fits_large_table_but_distorts_edges
- **name**: 0_5x FITS_large_table_but_distorts_edges
- **source_file**: raw/scenarios/cafe_flatlay_dessert.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__카페 디저트 플랫레이 — 수평과 왜곡 잡기__scenario_cafe_flatlay_dessert|카페 디저트 플랫레이 — 수평과 왜곡 잡기]] → `USES_TECHNIQUE`
