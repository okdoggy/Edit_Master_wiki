...
- **id**: editstyle_warm_blue_travel
- **key**: edit_style
- **value**: warm_blue_travel
- **name**: warm blue travel
- **source_file**: raw/scenarios/beach_backlit_portrait.md
...
- `TRIGGERS` → [[scene_nodes/scene__Personalized recommendation — 해변 역광 인물 — 여름_휴양지 SNS 스타일__rec_personalized_beach_backlit_portrait|Personalized recommendation — 해변 역광 인물 — 여름/휴양지 SNS 스타일]]

## Incoming
- [[scene_nodes/scene__해변 역광 인물 — 여름_휴양지 SNS 스타일__scenario_beach_backlit_portrait|해변 역광 인물 — 여름/휴양지 SNS 스타일]] → `HAS_EDIT_STYLE`
...
- [[scene_nodes/scene__Personalized recommendation — 해변 역광 인물 — 여름_휴양지 SNS 스타일__rec_personalized_beach_backlit_portrait|Personalized recommendation — 해변 역광 인물 — 여름/휴양지 SNS 스타일]] → `USES_FACET`
