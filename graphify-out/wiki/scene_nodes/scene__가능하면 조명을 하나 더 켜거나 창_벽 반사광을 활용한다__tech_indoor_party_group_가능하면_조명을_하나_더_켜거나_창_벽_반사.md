...
- id: `tech_indoor_party_group_가능하면_조명을_하나_더_켜거나_창_벽_반사광을_활용한다.`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_indoor_party_group_가능하면_조명을_하나_더_켜거나_창_벽_반사광을_활용한다.
- **name**: 가능하면 조명을 하나 더 켜거나 창/벽 반사광을 활용한다.
- **source_file**: raw/scenarios/indoor_party_group.md
...
## Incoming
- [[scene_nodes/scene__Trend recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임__rec_trend_indoor_party_group|Trend recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임]] → `USES_TECHNIQUE`
- [[scene_nodes/scene__General recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임__rec_general_indoor_party_group|General recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임]] → `USES_TECHNIQUE`
- [[scene_nodes/scene__Personalized recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임__rec_personalized_indoor_party_group|Personalized recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임]] → `USES_TECHNIQUE`
