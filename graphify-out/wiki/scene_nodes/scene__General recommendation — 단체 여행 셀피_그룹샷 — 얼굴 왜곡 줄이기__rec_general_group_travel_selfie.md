# General recommendation — 단체 여행 셀피/그룹샷 — 얼굴 왜곡 줄이기

- id: `rec_general_group_travel_selfie`
- graph: scene-first
...
## Properties
- **id**: rec_general_group_travel_selfie
- **name**: General recommendation — 단체 여행 셀피/그룹샷 — 얼굴 왜곡 줄이기
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/group_travel_selfie.md
...
- `USES_FACET` → [[scene_nodes/scene__0.5x 1x front__lens_0_5x_1x_front|0.5x 1x front]]
- `USES_FACET` → [[scene_nodes/scene__selfie or timer__mode_selfie_or_timer|selfie or timer]]
...
- [[scene_nodes/scene__0.5x 1x front__lens_0_5x_1x_front|0.5x 1x front]] → `TRIGGERS`
- [[scene_nodes/scene__selfie or timer__mode_selfie_or_timer|selfie or timer]] → `TRIGGERS`
