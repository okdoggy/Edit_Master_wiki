...
- **id**: mode_selfie_or_timer
- **key**: mode
- **value**: selfie_or_timer
- **name**: selfie or timer
- **source_file**: raw/scenarios/group_travel_selfie.md
...
## Incoming
- [[scene_nodes/scene__단체 여행 셀피_그룹샷 — 얼굴 왜곡 줄이기__scenario_group_travel_selfie|단체 여행 셀피/그룹샷 — 얼굴 왜곡 줄이기]] → `USES_MODE`
