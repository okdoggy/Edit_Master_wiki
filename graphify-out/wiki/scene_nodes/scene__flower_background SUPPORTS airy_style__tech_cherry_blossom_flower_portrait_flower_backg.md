...
- id: `tech_cherry_blossom_flower_portrait_flower_background_supports_airy_style`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_cherry_blossom_flower_portrait_flower_background_supports_airy_style
- **name**: flower_background SUPPORTS airy_style
- **source_file**: raw/scenarios/cherry_blossom_flower_portrait.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__벚꽃·꽃나무 아래 인물 — 밝고 부드러운 봄 스타일__scenario_cherry_blossom_flower_portrait|벚꽃·꽃나무 아래 인물 — 밝고 부드러운 봄 스타일]] → `USES_TECHNIQUE`
