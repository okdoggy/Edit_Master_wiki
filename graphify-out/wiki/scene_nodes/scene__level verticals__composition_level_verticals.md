...
- id: `composition_level_verticals`
- graph: scene-first
...
- **id**: composition_level_verticals
- **key**: composition
- **value**: level_verticals
- **name**: level verticals
- **source_file**: raw/scenarios/architecture_interior_wide.md
...
## Incoming
- [[scene_nodes/scene__건축·실내 공간 — 초광각 왜곡 제어__scenario_architecture_interior_wide|건축·실내 공간 — 초광각 왜곡 제어]] → `HAS_FACET`
