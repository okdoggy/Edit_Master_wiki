...
- id: `rec_personalized_window_light_cafe_portrait`
- graph: scene-first
...
## Properties
- **id**: rec_personalized_window_light_cafe_portrait
- **name**: Personalized recommendation — 카페 창가 인물 — 자연광/인플루언서 프로필
...
- `USES_FACET` → [[scene_nodes/scene__skin retouch strength__preference_skin_retouch_strength|skin retouch strength]]
...
- [[scene_nodes/scene__skin retouch strength__preference_skin_retouch_strength|skin retouch strength]] → `TRIGGERS`
