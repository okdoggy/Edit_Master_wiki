...
- id: `rec_general_snow_portrait_clean_winter`
- graph: scene-first
...
## Properties
- **id**: rec_general_snow_portrait_clean_winter
- **name**: General recommendation — 눈 오는 날 인물 — 깨끗한 겨울/하이키 스타일
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/snow_portrait_clean_winter.md
...
- `USES_FACET` → [[scene_nodes/scene__overcast reflection__light_overcast_reflection|overcast reflection]]
...
- [[scene_nodes/scene__overcast reflection__light_overcast_reflection|overcast reflection]] → `TRIGGERS`
