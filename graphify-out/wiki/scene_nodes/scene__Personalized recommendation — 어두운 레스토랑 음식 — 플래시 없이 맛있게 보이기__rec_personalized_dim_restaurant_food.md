# Personalized recommendation — 어두운 레스토랑 음식 — 플래시 없이 맛있게 보이기

- id: `rec_personalized_dim_restaurant_food`
- graph: scene-first
...
## Properties
- **id**: rec_personalized_dim_restaurant_food
- **name**: Personalized recommendation — 어두운 레스토랑 음식 — 플래시 없이 맛있게 보이기
