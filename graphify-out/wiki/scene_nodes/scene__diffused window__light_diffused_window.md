...
- **id**: light_diffused_window
- **key**: light
- **value**: diffused_window
- **name**: diffused window
- **source_file**: raw/scenarios/window_light_cafe_portrait.md
...
## Incoming
- [[scene_nodes/scene__카페 창가 인물 — 자연광_인플루언서 프로필__scenario_window_light_cafe_portrait|카페 창가 인물 — 자연광/인플루언서 프로필]] → `HAS_LIGHT`
