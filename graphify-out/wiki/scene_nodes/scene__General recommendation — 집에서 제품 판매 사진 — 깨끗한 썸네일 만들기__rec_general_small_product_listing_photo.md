# General recommendation — 집에서 제품 판매 사진 — 깨끗한 썸네일 만들기

- id: `rec_general_small_product_listing_photo`
- graph: scene-first
...
## Properties
- **id**: rec_general_small_product_listing_photo
- **name**: General recommendation — 집에서 제품 판매 사진 — 깨끗한 썸네일 만들기
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/small_product_listing_photo.md
...
- `USES_FACET` → [[scene_nodes/scene__product__subject_product|product]]
...
- [[scene_nodes/scene__product__subject_product|product]] → `TRIGGERS`
