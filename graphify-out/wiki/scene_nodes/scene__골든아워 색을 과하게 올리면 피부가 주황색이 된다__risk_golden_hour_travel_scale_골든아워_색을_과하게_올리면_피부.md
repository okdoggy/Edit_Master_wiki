...
- id: `risk_golden_hour_travel_scale_골든아워_색을_과하게_올리면_피부가_주황색이_된다.`
- graph: scene-first
- labels: Risk
...
## Properties
- **id**: risk_golden_hour_travel_scale_골든아워_색을_과하게_올리면_피부가_주황색이_된다.
- **name**: 골든아워 색을 과하게 올리면 피부가 주황색이 된다.
- **source_file**: raw/scenarios/golden_hour_travel_scale.md
...
## Incoming
- [[scene_nodes/scene__Trend recommendation — 여행 골든아워 — wide_detail_scale 3컷 추천__rec_trend_golden_hour_travel_scale|Trend recommendation — 여행 골든아워 — wide/detail/scale 3컷 추천]] → `AVOIDS`
- [[scene_nodes/scene__General recommendation — 여행 골든아워 — wide_detail_scale 3컷 추천__rec_general_golden_hour_travel_scale|General recommendation — 여행 골든아워 — wide/detail/scale 3컷 추천]] → `AVOIDS`
- [[scene_nodes/scene__Personalized recommendation — 여행 골든아워 — wide_detail_scale 3컷__rec_personalized_golden_hour_travel_scale|Personalized recommendation — 여행 골든아워 — wide/detail/scale 3컷 추천]] → `AVOIDS`
