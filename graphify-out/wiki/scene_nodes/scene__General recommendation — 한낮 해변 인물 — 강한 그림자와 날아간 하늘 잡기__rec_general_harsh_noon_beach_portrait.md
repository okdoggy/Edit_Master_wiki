# General recommendation — 한낮 해변 인물 — 강한 그림자와 날아간 하늘 잡기

- id: `rec_general_harsh_noon_beach_portrait`
- graph: scene-first
...
## Properties
- **id**: rec_general_harsh_noon_beach_portrait
- **name**: General recommendation — 한낮 해변 인물 — 강한 그림자와 날아간 하늘 잡기
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/harsh_noon_beach_portrait.md
...
- `USES_FACET` → [[scene_nodes/scene__1x 2x portrait__lens_1x_2x_portrait|1x 2x portrait]]
...
- [[scene_nodes/scene__1x 2x portrait__lens_1x_2x_portrait|1x 2x portrait]] → `TRIGGERS`
