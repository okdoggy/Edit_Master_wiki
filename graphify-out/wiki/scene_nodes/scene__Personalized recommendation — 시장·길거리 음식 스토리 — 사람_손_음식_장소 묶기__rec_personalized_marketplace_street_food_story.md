...
- id: `rec_personalized_marketplace_street_food_story`
- graph: scene-first
...
## Properties
- **id**: rec_personalized_marketplace_street_food_story
- **name**: Personalized recommendation — 시장·길거리 음식 스토리 — 사람/손/음식/장소 묶기
...
- `USES_FACET` → [[scene_nodes/scene__street food__subject_street_food|street food]]
...
- [[scene_nodes/scene__street food__subject_street_food|street food]] → `TRIGGERS`
