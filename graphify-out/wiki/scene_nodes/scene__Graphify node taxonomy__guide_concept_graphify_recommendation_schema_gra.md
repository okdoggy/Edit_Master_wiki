...
- id: `guide_concept_graphify_recommendation_schema_graphify_node_taxonomy`
- graph: scene-first
- labels: Technique
...
## Incoming
- [[scene_nodes/scene__Graphify 추천 연결 스키마 — 스마트폰 촬영_보정__guide_graphify_recommendation_schema|Graphify 추천 연결 스키마 — 스마트폰 촬영/보정]] → `REFERENCES`
