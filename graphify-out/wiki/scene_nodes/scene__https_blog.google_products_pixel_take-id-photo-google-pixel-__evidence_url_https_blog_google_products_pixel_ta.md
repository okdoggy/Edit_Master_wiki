...
- id: `evidence_url_https___blog.google_products_pixel_take_id_photo_google_pixel_tips`
- graph: scene-first
- labels: Evidence
- source_file: raw/scenarios/mirror_selfie_ootd.md
- source_url: https://blog.google/products/pixel/take-id-photo-google-pixel-tips/
...
## Properties
- **id**: evidence_url_https___blog.google_products_pixel_take_id_photo_google_pixel_tips
- **name**: https://blog.google/products/pixel/take-id-photo-google-pixel-tips/
- **source_url**: https://blog.google/products/pixel/take-id-photo-google-pixel-tips/
- **source_file**: raw/scenarios/mirror_selfie_ootd.md
