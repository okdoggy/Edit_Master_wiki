# General recommendation — 불꽃놀이와 스카이라인 — 하이라이트 보호/연속 확보

- id: `rec_general_fireworks_skyline`
- graph: scene-first
...
## Properties
- **id**: rec_general_fireworks_skyline
- **name**: General recommendation — 불꽃놀이와 스카이라인 — 하이라이트 보호/연속 확보
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/fireworks_skyline.md
...
- `USES_FACET` → [[scene_nodes/scene__fireworks__subject_fireworks|fireworks]]
- `USES_FACET` → [[scene_nodes/scene__night skyline__environment_night_skyline|night skyline]]
- `USES_FACET` → [[scene_nodes/scene__night or pro__mode_night_or_pro|night or pro]]
- `USES_FACET` → [[scene_nodes/scene__1x 0.5x__lens_1x_0_5x|1x 0.5x]]
...
- [[scene_nodes/scene__fireworks__subject_fireworks|fireworks]] → `TRIGGERS`
- [[scene_nodes/scene__night skyline__environment_night_skyline|night skyline]] → `TRIGGERS`
- [[scene_nodes/scene__night or pro__mode_night_or_pro|night or pro]] → `TRIGGERS`
- [[scene_nodes/scene__1x 0.5x__lens_1x_0_5x|1x 0.5x]] → `TRIGGERS`
