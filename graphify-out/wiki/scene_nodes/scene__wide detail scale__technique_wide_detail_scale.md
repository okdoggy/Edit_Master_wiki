...
- id: `technique_wide_detail_scale`
- graph: scene-first
- labels: SceneFacet, Technique
...
- **id**: technique_wide_detail_scale
- **key**: shot_set
- **value**: wide_detail_scale
- **name**: wide detail scale
- **source_file**: raw/scenarios/golden_hour_travel_scale.md
...
## Incoming
- [[scene_nodes/scene__여행 골든아워 — wide_detail_scale 3컷 추천__scenario_golden_hour_travel_scale|여행 골든아워 — wide/detail/scale 3컷 추천]] → `HAS_FACET`
