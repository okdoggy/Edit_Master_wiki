# General recommendation — 도시 야경 유리창 반사 — 산만한 반사 정리

- id: `rec_general_city_window_reflection`
- graph: scene-first
...
## Properties
- **id**: rec_general_city_window_reflection
- **name**: General recommendation — 도시 야경 유리창 반사 — 산만한 반사 정리
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/city_window_reflection.md
...
- `USES_FACET` → [[scene_nodes/scene__night or photo__mode_night_or_photo|night or photo]]
...
- [[scene_nodes/scene__night or photo__mode_night_or_photo|night or photo]] → `TRIGGERS`
