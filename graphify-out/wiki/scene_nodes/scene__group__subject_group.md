...
- `TRIGGERS` → [[scene_nodes/scene__Personalized recommendation — 단체 여행 셀피_그룹샷 — 얼굴 왜곡 줄이기__rec_personalized_group_travel_selfie|Personalized recommendation — 단체 여행 셀피/그룹샷 — 얼굴 왜곡 줄이기]]
...
- `TRIGGERS` → [[scene_nodes/scene__Personalized recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임__rec_personalized_indoor_party_group|Personalized recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임]]

## Incoming
- [[scene_nodes/scene__단체 여행 셀피_그룹샷 — 얼굴 왜곡 줄이기__scenario_group_travel_selfie|단체 여행 셀피/그룹샷 — 얼굴 왜곡 줄이기]] → `HAS_SUBJECT`
...
- [[scene_nodes/scene__Personalized recommendation — 단체 여행 셀피_그룹샷 — 얼굴 왜곡 줄이기__rec_personalized_group_travel_selfie|Personalized recommendation — 단체 여행 셀피/그룹샷 — 얼굴 왜곡 줄이기]] → `USES_FACET`
- [[scene_nodes/scene__실내 생일파티·모임 단체사진 — 어두운 실내와 움직임__scenario_indoor_party_group|실내 생일파티·모임 단체사진 — 어두운 실내와 움직임]] → `HAS_SUBJECT`
...
- [[scene_nodes/scene__Personalized recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임__rec_personalized_indoor_party_group|Personalized recommendation — 실내 생일파티·모임 단체사진 — 어두운 실내와 움직임]] → `USES_FACET`
