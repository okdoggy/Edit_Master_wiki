...
- id: `tech_concert_stage_low_light_noise_reduction_balances_detail`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_concert_stage_low_light_noise_reduction_balances_detail
- **name**: noise_reduction BALANCES_detail
- **source_file**: raw/scenarios/concert_stage_low_light.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__공연·무대 저조도 — 망원_하이라이트 보호__scenario_concert_stage_low_light|공연·무대 저조도 — 망원/하이라이트 보호]] → `USES_TECHNIQUE`
