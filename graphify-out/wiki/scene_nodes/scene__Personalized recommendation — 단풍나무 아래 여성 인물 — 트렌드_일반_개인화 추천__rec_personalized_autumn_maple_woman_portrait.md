# Personalized recommendation — 단풍나무 아래 여성 인물 — 트렌드/일반/개인화 추천 seed

- id: `rec_personalized_autumn_maple_woman_portrait`
- graph: scene-first
...
## Properties
- **id**: rec_personalized_autumn_maple_woman_portrait
- **name**: Personalized recommendation — 단풍나무 아래 여성 인물 — 트렌드/일반/개인화 추천 seed
...
- `USES_FACET` → [[scene_nodes/scene__warm foliage__editstyle_warm_foliage|warm foliage]]
- `USES_FACET` → [[scene_nodes/scene__skin tone preference__preference_skin_tone_preference|skin tone preference]]
...
- [[scene_nodes/scene__warm foliage__editstyle_warm_foliage|warm foliage]] → `TRIGGERS`
- [[scene_nodes/scene__skin tone preference__preference_skin_tone_preference|skin tone preference]] → `TRIGGERS`
- [[scene_nodes/scene__Skin too orange from warm color grade__issue_skin_too_orange|Skin too orange from warm color grade]] → `TRIGGERS`
