...
- id: `param_cafe_flatlay_dessert_whites_+5_+15_vibrance_+3_+8_texture_+3_+10.`
- graph: scene-first
- labels: Parameter
...
## Properties
- **id**: param_cafe_flatlay_dessert_whites_+5_+15_vibrance_+3_+8_texture_+3_+10.
- **name**: Whites +5~+15, Vibrance +3~+8, Texture +3~+10.
- **source_file**: raw/scenarios/cafe_flatlay_dessert.md
...
## Incoming
- [[scene_nodes/scene__Trend recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기__rec_trend_cafe_flatlay_dessert|Trend recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기]] → `SETS_PARAMETER`
- [[scene_nodes/scene__General recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기__rec_general_cafe_flatlay_dessert|General recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기]] → `SETS_PARAMETER`
- [[scene_nodes/scene__Personalized recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기__rec_personalized_cafe_flatlay_dessert|Personalized recommendation — 카페 디저트 플랫레이 — 수평과 왜곡 잡기]] → `SETS_PARAMETER`
