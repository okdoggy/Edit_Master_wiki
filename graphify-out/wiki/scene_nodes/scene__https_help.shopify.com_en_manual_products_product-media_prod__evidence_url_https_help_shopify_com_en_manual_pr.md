...
- id: `evidence_url_https___help.shopify.com_en_manual_products_product_media_product_photography`
- graph: scene-first
- labels: Evidence
- source_file: raw/scenarios/small_product_listing_photo.md
- source_url: https://help.shopify.com/en/manual/products/product-media/product-photography
...
## Properties
- **id**: evidence_url_https___help.shopify.com_en_manual_products_product_media_product_photography
- **name**: https://help.shopify.com/en/manual/products/product-media/product-photography
- **source_url**: https://help.shopify.com/en/manual/products/product-media/product-photography
- **source_file**: raw/scenarios/small_product_listing_photo.md
