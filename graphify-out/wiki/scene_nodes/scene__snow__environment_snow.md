...
- `TRIGGERS` → [[scene_nodes/scene__Personalized recommendation — 눈 오는 날 인물 — 깨끗한 겨울_하이키 스타일__rec_personalized_snow_portrait_clean_winter|Personalized recommendation — 눈 오는 날 인물 — 깨끗한 겨울/하이키 스타일]]

## Incoming
- [[scene_nodes/scene__눈 오는 날 인물 — 깨끗한 겨울_하이키 스타일__scenario_snow_portrait_clean_winter|눈 오는 날 인물 — 깨끗한 겨울/하이키 스타일]] → `HAS_ENVIRONMENT`
...
- [[scene_nodes/scene__Personalized recommendation — 눈 오는 날 인물 — 깨끗한 겨울_하이키 스타일__rec_personalized_snow_portrait_clean_winter|Personalized recommendation — 눈 오는 날 인물 — 깨끗한 겨울/하이키 스타일]] → `USES_FACET`
