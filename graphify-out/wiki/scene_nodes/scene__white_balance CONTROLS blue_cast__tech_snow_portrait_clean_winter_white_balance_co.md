...
- id: `tech_snow_portrait_clean_winter_white_balance_controls_blue_cast`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_snow_portrait_clean_winter_white_balance_controls_blue_cast
- **name**: white_balance CONTROLS blue_cast
- **source_file**: raw/scenarios/snow_portrait_clean_winter.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__눈 오는 날 인물 — 깨끗한 겨울_하이키 스타일__scenario_snow_portrait_clean_winter|눈 오는 날 인물 — 깨끗한 겨울/하이키 스타일]] → `USES_TECHNIQUE`
