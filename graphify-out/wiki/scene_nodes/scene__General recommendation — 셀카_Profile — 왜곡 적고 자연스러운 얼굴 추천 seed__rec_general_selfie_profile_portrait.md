# General recommendation — 셀카/Profile — 왜곡 적고 자연스러운 얼굴 추천 seed

- id: `rec_general_selfie_profile_portrait`
- graph: scene-first
...
## Properties
- **id**: rec_general_selfie_profile_portrait
- **name**: General recommendation — 셀카/Profile — 왜곡 적고 자연스러운 얼굴 추천 seed
- **channel**: general
- **rank_score**: 0.82
- **source_file**: raw/scenarios/selfie_profile_portrait.md
...
- `USES_FACET` → [[scene_nodes/scene__selfie or portrait selfie__mode_selfie_or_portrait_selfie|selfie or portrait selfie]]
- `USES_FACET` → [[scene_nodes/scene__window or open shade__light_window_or_open_shade|window or open shade]]
...
- [[scene_nodes/scene__selfie or portrait selfie__mode_selfie_or_portrait_selfie|selfie or portrait selfie]] → `TRIGGERS`
- [[scene_nodes/scene__window or open shade__light_window_or_open_shade|window or open shade]] → `TRIGGERS`
