...
- id: `param_group_travel_selfie_삼각대_난간_+_타이머_3초로_후면_카메라_사용하면_품질_상승.`
- graph: scene-first
- labels: Parameter
...
## Properties
- **id**: param_group_travel_selfie_삼각대_난간_+_타이머_3초로_후면_카메라_사용하면_품질_상승.
- **name**: 삼각대/난간 + 타이머 3초로 후면 카메라 사용하면 품질 상승.
- **source_file**: raw/scenarios/group_travel_selfie.md
...
## Incoming
- [[scene_nodes/scene__Trend recommendation — 단체 여행 셀피_그룹샷 — 얼굴 왜곡 줄이기__rec_trend_group_travel_selfie|Trend recommendation — 단체 여행 셀피/그룹샷 — 얼굴 왜곡 줄이기]] → `USES_TECHNIQUE`
- [[scene_nodes/scene__General recommendation — 단체 여행 셀피_그룹샷 — 얼굴 왜곡 줄이기__rec_general_group_travel_selfie|General recommendation — 단체 여행 셀피/그룹샷 — 얼굴 왜곡 줄이기]] → `USES_TECHNIQUE`
- [[scene_nodes/scene__Personalized recommendation — 단체 여행 셀피_그룹샷 — 얼굴 왜곡 줄이기__rec_personalized_group_travel_selfie|Personalized recommendation — 단체 여행 셀피/그룹샷 — 얼굴 왜곡 줄이기]] → `USES_TECHNIQUE`
