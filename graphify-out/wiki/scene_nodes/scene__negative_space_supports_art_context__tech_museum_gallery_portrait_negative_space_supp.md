...
- id: `tech_museum_gallery_portrait_negative_space_supports_art_context`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_museum_gallery_portrait_negative_space_supports_art_context
- **name**: negative_space_supports_art_context
- **source_file**: raw/scenarios/museum_gallery_portrait.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__미술관·전시회 인물 — 플래시 없이 차분하게__scenario_museum_gallery_portrait|미술관·전시회 인물 — 플래시 없이 차분하게]] → `USES_TECHNIQUE`
