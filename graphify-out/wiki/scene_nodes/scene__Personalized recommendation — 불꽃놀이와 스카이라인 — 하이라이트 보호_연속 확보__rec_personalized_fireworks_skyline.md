# Personalized recommendation — 불꽃놀이와 스카이라인 — 하이라이트 보호/연속 확보

- id: `rec_personalized_fireworks_skyline`
- graph: scene-first
...
## Properties
- **id**: rec_personalized_fireworks_skyline
- **name**: Personalized recommendation — 불꽃놀이와 스카이라인 — 하이라이트 보호/연속 확보
