...
- id: `param_fashion_ootd_portrait_카메라_시작값__exposure_0_+0.3_grid_on.`
- graph: scene-first
- labels: Parameter
...
## Properties
- **id**: param_fashion_ootd_portrait_카메라_시작값__exposure_0_+0.3_grid_on.
- **name**: 카메라 시작값: Exposure 0~+0.3, Grid ON.
- **source_file**: raw/scenarios/fashion_ootd_portrait.md
...
## Incoming
- [[scene_nodes/scene__Trend recommendation — 패션_OOTD 인물 — 전신 비율과 옷 색을 살리는 추천 seed__rec_trend_fashion_ootd_portrait|Trend recommendation — 패션/OOTD 인물 — 전신 비율과 옷 색을 살리는 추천 seed]] → `USES_TECHNIQUE`
- [[scene_nodes/scene__General recommendation — 패션_OOTD 인물 — 전신 비율과 옷 색을 살리는 추천 see__rec_general_fashion_ootd_portrait|General recommendation — 패션/OOTD 인물 — 전신 비율과 옷 색을 살리는 추천 seed]] → `USES_TECHNIQUE`
- [[scene_nodes/scene__Personalized recommendation — 패션_OOTD 인물 — 전신 비율과 옷 색을 살리는 추__rec_personalized_fashion_ootd_portrait|Personalized recommendation — 패션/OOTD 인물 — 전신 비율과 옷 색을 살리는 추천 seed]] → `USES_TECHNIQUE`
