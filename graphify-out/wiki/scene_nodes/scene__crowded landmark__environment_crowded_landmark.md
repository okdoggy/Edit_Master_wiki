...
- id: `environment_crowded_landmark`
- graph: scene-first
...
- **id**: environment_crowded_landmark
- **key**: environment
- **value**: crowded_landmark
- **name**: crowded landmark
- **source_file**: raw/scenarios/crowded_landmark_portrait.md
...
## Incoming
- [[scene_nodes/scene__관광지 랜드마크 인물 — 사람 많은 배경 정리__scenario_crowded_landmark_portrait|관광지 랜드마크 인물 — 사람 많은 배경 정리]] → `HAS_ENVIRONMENT`
