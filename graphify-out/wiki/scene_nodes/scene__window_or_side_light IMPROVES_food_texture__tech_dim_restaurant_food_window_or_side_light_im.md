...
- id: `tech_dim_restaurant_food_window_or_side_light_improves_food_texture`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_dim_restaurant_food_window_or_side_light_improves_food_texture
- **name**: window_or_side_light IMPROVES_food_texture
- **source_file**: raw/scenarios/dim_restaurant_food.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__어두운 레스토랑 음식 — 플래시 없이 맛있게 보이기__scenario_dim_restaurant_food|어두운 레스토랑 음식 — 플래시 없이 맛있게 보이기]] → `USES_TECHNIQUE`
