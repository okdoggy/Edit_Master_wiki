...
- id: `tech_golden_hour_travel_scale_detail_shot_creates_memory`
- graph: scene-first
- labels: Technique
...
## Properties
- **id**: tech_golden_hour_travel_scale_detail_shot_creates_memory
- **name**: detail_shot CREATES_memory
- **source_file**: raw/scenarios/golden_hour_travel_scale.md
- **extracted_edge**: True
...
## Incoming
- [[scene_nodes/scene__여행 골든아워 — wide_detail_scale 3컷 추천__scenario_golden_hour_travel_scale|여행 골든아워 — wide/detail/scale 3컷 추천]] → `USES_TECHNIQUE`
