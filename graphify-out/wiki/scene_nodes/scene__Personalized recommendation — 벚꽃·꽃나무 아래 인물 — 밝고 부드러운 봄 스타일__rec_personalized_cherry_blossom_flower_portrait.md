# Personalized recommendation — 벚꽃·꽃나무 아래 인물 — 밝고 부드러운 봄 스타일

- id: `rec_personalized_cherry_blossom_flower_portrait`
- graph: scene-first
...
## Properties
- **id**: rec_personalized_cherry_blossom_flower_portrait
- **name**: Personalized recommendation — 벚꽃·꽃나무 아래 인물 — 밝고 부드러운 봄 스타일
