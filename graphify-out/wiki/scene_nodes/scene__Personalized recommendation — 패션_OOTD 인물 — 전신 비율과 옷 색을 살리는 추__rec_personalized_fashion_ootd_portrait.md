...
- id: `rec_personalized_fashion_ootd_portrait`
- graph: scene-first
...
## Properties
- **id**: rec_personalized_fashion_ootd_portrait
- **name**: Personalized recommendation — 패션/OOTD 인물 — 전신 비율과 옷 색을 살리는 추천 seed
...
- `USES_FACET` → [[scene_nodes/scene__outfit color priority__preference_outfit_color_priority|outfit color priority]]
...
- [[scene_nodes/scene__outfit color priority__preference_outfit_color_priority|outfit color priority]] → `TRIGGERS`
