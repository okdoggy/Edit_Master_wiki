...
# contrast clarity for text

## Connections
- [[문서화이트보드 스캔 보정 - 글자 가독성과 원근 교정 추천 seed bc76a9]] - `SETS_PARAMETER` [EXTRACTED]
- [[화이트보드·메뉴판 가독성 사진 - 원근, 눈부심, OCR 친화 보정 seed f645c0]] - `SETS_PARAMETER` [EXTRACTED]
